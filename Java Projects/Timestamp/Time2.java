//Time2 - Class declarations to with overloaded constructors
//David Amos
//References - 
...
public class Time2
{
   ...
   //Create new variable totalSeconds
   ...
   public Time2(long totalSeconds)
   {
       this.totalSeconds=totalSeconds;
       hour=(int)(totalSeconds/3600);
       int rseconds=(int)(totalSeconds%3600);
